...
HoReCa и оптовых покупателей. Пишет в PostgreSQL (схема source_vfd):
  - source_vfd.customers            — справочник клиентов (master data)
  - source_vfd.products             — справочник SKU (master data)
  - source_vfd.orders               — шапка заказа (snapshot)
  - source_vfd.order_items          — позиции заказа (snapshot)
  - source_vfd.shipments            — отгрузка/доставка (snapshot)
  - source_vfd.order_status_history — история статусов (append-only events)
  - source_vfd.payments             — оплаты/дебиторка (events)
  - source_vfd.returns              — возвраты (events)

Пайплайн:  Generator → PostgreSQL → Airflow → Spark → MinIO → ClickHouse → dbt → Metabase

Данные максимально приближены к реальным:
  - Реальные бренды ВФД: «Ферма Волги», «Сливочный Берег», «Северная Линия», «Лесные Друзья»
...
Использование:
  python vfd_batch_generator.py
  python vfd_batch_generator.py --orders 100000 --days 180
  python vfd_batch_generator.py --mode incremental
"""
...
PRODUCTS = [
    {"sku": "SZ-MLK-P-025-093", "name": "Молоко питьевое пастеризованное 2,5%", "brand": "Ферма Волги", "category": "молоко", "subcategory": "пастеризованное",
    ...
    {"sku": "SZ-MLK-P-032-093", "name": "Молоко питьевое пастеризованное 3,2%", "brand": "Ферма Волги", "category": "молоко", "subcategory": "пастеризованное",
    ...
    {"sku": "SZ-MLK-U-015-095", "name": "Молоко питьевое ультрапастеризованное 1,5%", "brand": "Ферма Волги", "category": "молоко", "subcategory": "ультрапастеризованное",
    ...
    {"sku": "SZ-MLK-U-025-095", "name": "Молоко питьевое ультрапастеризованное 2,5%", "brand": "Ферма Волги", "category": "молоко", "subcategory": "ультрапастеризованное",
    ...
    {"sku": "SZ-MLK-U-032-095", "name": "Молоко питьевое ультрапастеризованное 3,2%", "brand": "Ферма Волги", "category": "молоко", "subcategory": "ультрапастеризованное",
    ...
    {"sku": "SZ-MLK-T-032-050", "name": "Молоко питьевое топлёное ультрапастеризованное 3,2%", "brand": "Ферма Волги", "category": "молоко", "subcategory": "топлёное",
    ...
    {"sku": "MR-MLK-U-032-097", "name": "Молоко питьевое ультрапастеризованное 3,2%", "brand": "Сливочный Берег", "category": "молоко", "subcategory": "ультрапастеризованное",
    ...
    {"sku": "MR-MLK-U-025-097", "name": "Молоко питьевое ультрапастеризованное 2,5%", "brand": "Сливочный Берег", "category": "молоко", "subcategory": "ультрапастеризованное",
    ...
    {"sku": "SZ-KEF-010-093", "name": "Кефир 1%", "brand": "Ферма Волги", "category": "кефир", "subcategory": "классический",
    ...
    {"sku": "SZ-KEF-025-093", "name": "Кефир 2,5%", "brand": "Ферма Волги", "category": "кефир", "subcategory": "классический",
    ...
    {"sku": "SZ-KEF-032-093", "name": "Кефир 3,2%", "brand": "Ферма Волги", "category": "кефир", "subcategory": "классический",
    ...
    {"sku": "SZ-RZH-025-093", "name": "Ряженка 2,5%", "brand": "Ферма Волги", "category": "ряженка", "subcategory": "классическая",
    ...
    {"sku": "SZ-RZH-032-043", "name": "Ряженка 3,2%", "brand": "Ферма Волги", "category": "ряженка", "subcategory": "классическая",
    ...
    {"sku": "SZ-SMT-010-030", "name": "Сметана 10%", "brand": "Ферма Волги", "category": "сметана", "subcategory": "классическая",
    ...
    {"sku": "SZ-SMT-015-030", "name": "Сметана 15%", "brand": "Ферма Волги", "category": "сметана", "subcategory": "классическая",
    ...
    {"sku": "SZ-SMT-020-030", "name": "Сметана 20%", "brand": "Ферма Волги", "category": "сметана", "subcategory": "классическая",
    ...
    {"sku": "SZ-TVR-000-018", "name": "Творог обезжиренный", "brand": "Ферма Волги", "category": "творог", "subcategory": "классический",
    ...
    {"sku": "SZ-TVR-018-020", "name": "Творог 1,8%", "brand": "Ферма Волги", "category": "творог", "subcategory": "классический",
    ...
    {"sku": "SZ-TVR-050-020", "name": "Творог 5%", "brand": "Ферма Волги", "category": "творог", "subcategory": "классический",
    ...
    {"sku": "SZ-TVR-090-030", "name": "Творог 9%", "brand": "Ферма Волги", "category": "творог", "subcategory": "классический",
    ...
    {"sku": "SZ-TVR-Z50-030", "name": "Творожное зерно 5%", "brand": "Ферма Волги", "category": "творог", "subcategory": "зернёный",
     "volume": "300 г", "weight_kg": 0.30, "unit": "стакан", "pack_qty": 8, "base_price": 115.0, "shelf_life_days": 14, "gost": "ТУ", "fat_pct": 5.0, "halal": True},
    {"sku": "MR-TVR-050-020", "name": "Творог 5%", "brand": "Сливочный Берег", "category": "творог", "subcategory": "классический",
    ...
    {"sku": "VK-TVR-050-020", "name": "Творог 5%", "brand": "Северная Линия", "category": "творог", "subcategory": "классический",
    ...
    {"sku": "SZ-SLV-010-020", "name": "Сливки питьевые стерилизованные 10%", "brand": "Ферма Волги", "category": "сливки", "subcategory": "питьевые",
    ...
    {"sku": "SZ-SLV-010-050", "name": "Сливки питьевые стерилизованные 10%", "brand": "Ферма Волги", "category": "сливки", "subcategory": "питьевые",
    ...
    {"sku": "SZ-SLV-020-020", "name": "Сливки стерилизованные 20%", "brand": "Ферма Волги", "category": "сливки", "subcategory": "питьевые",
    ...
    {"sku": "MR-SLV-011-020", "name": "Сливки питьевые 11%", "brand": "Сливочный Берег", "category": "сливки", "subcategory": "питьевые",
    ...
    {"sku": "MR-SLV-022-100", "name": "Сливки питьевые 22%", "brand": "Сливочный Берег", "category": "сливки", "subcategory": "для кулинарии",
    ...
    {"sku": "MR-SLV-033-100", "name": "Сливки для взбивания 33%", "brand": "Сливочный Берег", "category": "сливки", "subcategory": "для взбивания",
    ...
    {"sku": "SZ-KTK-032-043", "name": "Катык 3,2%", "brand": "Ферма Волги", "category": "катык", "subcategory": "классический",
     "volume": "430 г", "weight_kg": 0.43, "unit": "ПЭТ", "pack_qty": 12, "base_price": 58.0, "shelf_life_days": 10, "gost": "ТУ", "fat_pct": 3.2, "halal": True},

    {"sku": "SZ-SNZ-032-043", "name": "Снежок 3,2%", "brand": "Ферма Волги", "category": "снежок", "subcategory": "сладкий",
     "volume": "430 г", "weight_kg": 0.43, "unit": "ПЭТ", "pack_qty": 12, "base_price": 54.0, "shelf_life_days": 10, "gost": "ТУ", "fat_pct": 3.2, "halal": True},

    {"sku": "SZ-YGR-KLB-025", "name": "Йогурт питьевой клубника 2,5%", "brand": "Ферма Волги", "category": "йогурт", "subcategory": "питьевой фруктовый",
    ...
    {"sku": "SZ-YGR-CHR-025", "name": "Йогурт питьевой черника 2,5%", "brand": "Ферма Волги", "category": "йогурт", "subcategory": "питьевой фруктовый",
     "volume": "290 г", "weight_kg": 0.30, "unit": "ПЭТ", "pack_qty": 12, "base_price": 55.0, "shelf_life_days": 21, "gost": "ГОСТ 31981-2013", "fat_pct": 2.5, "halal": True},
    {"sku": "SZ-YGR-ZLK-015", "name": "Йогурт питьевой злаки 1,5%", "brand": "Ферма Волги", "category": "йогурт", "subcategory": "питьевой фруктовый",
    ...
    {"sku": "SZ-MSL-725-018", "name": "Масло сливочное Крестьянское 72,5%", "brand": "Ферма Волги", "category": "масло", "subcategory": "крестьянское",
    ...
    {"sku": "SZ-MSL-825-018", "name": "Масло сливочное Традиционное 82,5%", "brand": "Ферма Волги", "category": "масло", "subcategory": "традиционное",
    ...
    {"sku": "SZ-SYR-MOZ-030", "name": "Сыр рассольный Моцарелла для пиццы 40%", "brand": "Ферма Волги", "category": "сыр", "subcategory": "рассольный",
     "volume": "300 г", "weight_kg": 0.30, "unit": "картон", "pack_qty": 10, "base_price": 240.0, "shelf_life_days": 30, "gost": "ТУ", "fat_pct": 40.0, "halal": True},

    {"sku": "SZ-KKT-CAP-020", "name": "Коктейль молочный Капучино 3,2%", "brand": "Ферма Волги", "category": "коктейль", "subcategory": "молочный",
     "volume": "200 г", "weight_kg": 0.21, "unit": "ТБА", "pack_qty": 24, "base_price": 42.0, "shelf_life_days": 180, "gost": "ТУ", "fat_pct": 3.2, "halal": True},

    {"sku": "SZ-SYV-PMR-050", "name": "Напиток на основе молочной сыворотки персик-маракуйя", "brand": "Ферма Волги", "category": "сыворотка", "subcategory": "фруктовая",
     "volume": "500 мл", "weight_kg": 0.52, "unit": "ТБА", "pack_qty": 12, "base_price": 48.0, "shelf_life_days": 150, "gost": "ТУ", "fat_pct": 0.0, "halal": True},

    {"sku": "TP-MLK-032-020", "name": "Молоко витаминизированное 3,2%", "brand": "Лесные Друзья", "category": "молоко", "subcategory": "детское",
    ...
    {"sku": "VFD-PRK-025-043", "name": "Простокваша Мечниковская 2,5%", "brand": "ВФД", "category": "простокваша", "subcategory": "классическая",
     "volume": "430 г", "weight_kg": 0.43, "unit": "ПЭТ", "pack_qty": 12, "base_price": 52.0, "shelf_life_days": 7, "gost": "ТУ", "fat_pct": 2.5, "halal": True},
    {"sku": "VFD-NAR-025-043", "name": "Напиток кисломолочный Наринэ 2,5%", "brand": "ВФД", "category": "наринэ", "subcategory": "функциональный",
     "volume": "430 г", "weight_kg": 0.43, "unit": "ПЭТ", "pack_qty": 12, "base_price": 56.0, "shelf_life_days": 10, "gost": "ТУ", "fat_pct": 2.5, "halal": True},

    {"sku": "VFD-SMS-025", "name": "Сыворотка молочная сухая", "brand": "ВФД", "category": "сухие продукты", "subcategory": "промышленная",
    ...
    {"sku": "VFD-SOM-025", "name": "Сухое обезжиренное молоко (СОМ)", "brand": "ВФД", "category": "сухие продукты", "subcategory": "промышленная",
...
WAREHOUSES = [
    {"id": "WH-MAIN",  "name": "Основной склад ВФД",              "address": "г. Казань, ул. Академика Арбузова, 7"},
...
COMPANY_DETAILS = {
    "legal_name": 'ООО "Волжский Фуд Дистрибьюшн"',
    "inn": "1660297582", "kpp": "166001001", "ogrn": "1171690074126",
    "address": "420088, Республика Татарстан, г. Казань, ул. Академика Арбузова, д. 7",
    "holding": "ВОЛГА ФУД ХОЛДИНГ",
}

DDL = """
CREATE SCHEMA IF NOT EXISTS source_vfd;

DROP TABLE IF EXISTS source_vfd.returns              CASCADE;
DROP TABLE IF EXISTS source_vfd.payments             CASCADE;
DROP TABLE IF EXISTS source_vfd.order_status_history CASCADE;
DROP TABLE IF EXISTS source_vfd.shipments            CASCADE;
DROP TABLE IF EXISTS source_vfd.order_items          CASCADE;
DROP TABLE IF EXISTS source_vfd.orders               CASCADE;
DROP TABLE IF EXISTS source_vfd.customers            CASCADE;
DROP TABLE IF EXISTS source_vfd.products             CASCADE;

CREATE TABLE source_vfd.customers (
...
CREATE INDEX idx_customers_type   ON source_vfd.customers (customer_type);
CREATE INDEX idx_customers_region ON source_vfd.customers (customer_region);

CREATE TABLE source_vfd.products (
...
CREATE INDEX idx_products_brand    ON source_vfd.products (brand);
CREATE INDEX idx_products_category ON source_vfd.products (category);

CREATE TABLE source_vfd.orders (
    order_id               VARCHAR(64)    PRIMARY KEY,
    supplier_name          VARCHAR(256)   NOT NULL,
    supplier_inn           VARCHAR(12)    NOT NULL,
    supplier_kpp           VARCHAR(9),
    customer_id            VARCHAR(32)    NOT NULL REFERENCES source_vfd.customers(customer_id),
    customer_name          VARCHAR(256)   NOT NULL,
    customer_type          VARCHAR(32)    NOT NULL,
    customer_inn           VARCHAR(20)    NOT NULL,
    customer_region        VARCHAR(128),
...
CREATE INDEX idx_orders_event_ts ON source_vfd.orders (event_timestamp);
CREATE INDEX idx_orders_customer ON source_vfd.orders (customer_id);
CREATE INDEX idx_orders_status   ON source_vfd.orders (status);
CREATE INDEX idx_orders_created  ON source_vfd.orders (created_at);

CREATE TABLE source_vfd.order_items (
    order_id              VARCHAR(64)    NOT NULL REFERENCES source_vfd.orders(order_id),
    line_number           INTEGER        NOT NULL,
    sku                   VARCHAR(32)    NOT NULL REFERENCES source_vfd.products(sku),
    product_name          VARCHAR(256)   NOT NULL,
    brand                 VARCHAR(64)    NOT NULL,
    category              VARCHAR(64)    NOT NULL,
    subcategory           VARCHAR(64),
...
CREATE INDEX idx_items_event_ts ON source_vfd.order_items (event_timestamp);
CREATE INDEX idx_items_sku      ON source_vfd.order_items (sku);
CREATE INDEX idx_items_brand    ON source_vfd.order_items (brand);

CREATE TABLE source_vfd.shipments (
...
CREATE INDEX idx_ship_event_ts ON source_vfd.shipments (event_timestamp);
CREATE INDEX idx_ship_order    ON source_vfd.shipments (order_id);
CREATE INDEX idx_ship_status   ON source_vfd.shipments (status);

CREATE TABLE source_vfd.order_status_history (
...
CREATE INDEX idx_osh_order_ts ON source_vfd.order_status_history (order_id, status_ts);
CREATE INDEX idx_osh_status  ON source_vfd.order_status_history (status);

CREATE TABLE source_vfd.payments (
...
CREATE INDEX idx_pay_order   ON source_vfd.payments (order_id);
CREATE INDEX idx_pay_due     ON source_vfd.payments (due_date);
CREATE INDEX idx_pay_status  ON source_vfd.payments (status);

CREATE TABLE source_vfd.returns (
...
CREATE INDEX idx_ret_order ON source_vfd.returns (order_id);
"""
...
def generate_order(order_dt):
    ...
    if not is_cancelled and random.random() < 0.70:
        ...
        shipment = {
            ...
            "carrier": random.choice([
                "Собственный автопарк ВФД", "ТК Вектор Логистик",
                "ТК Астра Логистик", "ТК Магистраль", "ТК Север-Транс"
            ]),
            "vehicle_plate": plate,
    ...
    order = {
        "order_id": order_id,
        "supplier_name": COMPANY_DETAILS["legal_name"],
        "supplier_inn": COMPANY_DETAILS["inn"], "supplier_kpp": COMPANY_DETAILS["kpp"],
        "customer_id": customer["id"], "customer_name": customer["name"],
    ...
    with conn.cursor() as cur:
        if orders_buf:
            ...
            execute_values(
                cur,
                f"""
                INSERT INTO source_vfd.orders ({cols}) VALUES %s
        ...
        if items_buf:
            ...
            execute_values(
                cur,
                f"INSERT INTO source_vfd.order_items ({cols}) VALUES %s ON CONFLICT DO NOTHING",
        ...
        if ships_buf:
            ...
            execute_values(
                cur,
                f"""
                INSERT INTO source_vfd.shipments ({cols}) VALUES %s
        ...
        if status_buf:
            ...
            execute_values(
                cur,
                f"INSERT INTO source_vfd.order_status_history ({cols}) VALUES %s ON CONFLICT DO NOTHING",
        ...
        if payments_buf:
            ...
            execute_values(
                cur,
                f"INSERT INTO source_vfd.payments ({cols}) VALUES %s ON CONFLICT DO NOTHING",
        ...
        if returns_buf:
            ...
            execute_values(
                cur,
                f"INSERT INTO source_vfd.returns ({cols}) VALUES %s ON CONFLICT DO NOTHING",
...
def insert_reference_data(conn):
    ...
    with conn.cursor() as cur:
        ...
        execute_values(
            cur,
            f"""
            INSERT INTO source_vfd.customers ({cols}) VALUES %s
        ...
        execute_values(
            cur,
            f"""
            INSERT INTO source_vfd.products ({cols}) VALUES %s
...
def run_historical(total_orders, days_back):
    ...
    print("=" * 70)
    print(f"  VFD Batch Generator → PostgreSQL")
    print(f"  {COMPANY_DETAILS['legal_name']}")
    print(f"  Холдинг:   {COMPANY_DETAILS['holding']}")
    ...
    print("      ✓ source_vfd.customers, products")
    print("      ✓ source_vfd.orders, order_items, shipments")
    print("      ✓ source_vfd.order_status_history, payments, returns")
    ...
    if recent:
        ...
        with conn.cursor() as cur:
            for order_id, cur_status, created_at in picked:
                ...
                cur.execute(
                    "SELECT shipment_id, status, shipped_at, estimated_arrival, actual_arrival FROM source_vfd.shipments WHERE order_id=%s LIMIT 1",
                    (oid,),
                )
                ...
                if st in ("new",):
                    ...
                    if not ship_row:
                        ...
                        late_ships.append({
                            ...
                            "status": "delivered",
                            "carrier": random.choice(["Собственный автопарк ВФД", "ТК Вектор Логистик", "ТК Астра Логистик"]),
                            "vehicle_plate": None,
                            "vehicle_type": None,
                            "driver_name": fake.name(),
                            "temperature_zone": random.choice(["2-6°C", "0-4°C", "2-4°C"]),
                    ...
                    cur.execute("SELECT 1 FROM source_vfd.payments WHERE order_id=%s LIMIT 1", (oid,))
                    if not cur.fetchone():
                    ...
                    if random.random() < 0.02:
                        cur.execute(
                            "SELECT line_number, sku, price_per_unit, quantity FROM source_vfd.order_items WHERE order_id=%s ORDER BY random() LIMIT 1",
                            (oid,),
                        )
                        li = cur.fetchone()
                        if li:
                ...
                if next_status:
                    cur.execute(
                        "UPDATE source_vfd.orders SET status=%s, updated_at=%s, event_timestamp=%s WHERE order_id=%s",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="VFD Batch Generator → PostgreSQL",
